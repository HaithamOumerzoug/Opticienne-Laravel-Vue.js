...
<div class="container mt-5">
    ...
    <h1 class="h3 mb-0 text-gray-800">Modifier le patient n°{{ $patient->id }}</h1>
    </div>
    ...
    <form method="POST" action="{{ route('patients.update',['patient'=>$patient->id]) }}" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn-block btn btn-primary">Enregistrer la modification</button>
          </form>
    </div>
